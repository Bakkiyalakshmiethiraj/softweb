...
<body >
    ...
    <h2>one of the most trusted and valuable company</h2>
    <h2>PRODUCTS</h2>
    <a href="sign.html">
...
<footer style="background-color:darkmagenta;margin-top: 143; border: none;">
    <P style="color:#ffffff; ;"align="center">Designed and Devoloped by BAKKIYALAKSHMI 2023 </P>
</footer>
</html>
...
<html>
    ...
    <body>
        ...
        <img src="prod.PNG" height="500" width="800">
    </center>
    </body>
    <footer style="background-color:darkmagenta;margin-top: 64; border: none;">
        <P style="color:#ffffff; ;"align="center">Designed and Devoloped by BAKKIYALAKSHMI E 2023 </P>
    </footer>
</html>
...
<body>
    ...
    <div class="photos">
    <img src=" lali.JPG" height="200" width="170">
    <img src="amma.JPG" height="200" width="170">
    <img src=" appa.JPG" height="200" width="170">
    <img src="sri.JPG" height="200" width="170">
    <img src="go.JPG" height="200" width="170">
    <img src="green.JPG" height="200" width="170">
    <img src="raji.JPG" height="200" width="170">
</div>
<div CLASS="names">
    <P>MIS BAKKI</P>    
    <P style="margin-left:-20;">MRS SATHIYA</P>    
    <P>MR RAJ</P>    
    <P>MR SRIRAM</P>    
    <P>MR GOKUL</P>    
    <P>MR GREEN</P>    
...
<footer style="background-color:darkmagenta;margin-top: 143; border: none;">
    <P style="color:#ffffff; ;"align="center">Designed and Devoloped by BAKKKIYALAKSHMI E 2023 </P>
</footer>
</html>
...
<body>
    ...
    <div class="form">
        <p align="center">JOIN THE FAMILY OF INFO TECH</p>
...
<body>
    ...
    <div class="company">
       ...
       <p> <b >Address</b></p>
        <p >1/8 Post Office Street,Anathur,Gingee</p>
        <p >Gingee Post</p>
        <p >Chennai-604 206</p>
        <b >Email:</b>
        <p >bakkiyalakshmiethiraj@gmail.com</p>
        <b >Phone</b>
        <p >6374527209</p>
    </center>
    </div>
...
## OUTPUT:
![Alt text](<scr1 soft.png>)
![Alt text](<scr2 soft.png>)
![Alt text](<scr3 soft.png>)
![Alt text](<scr4 soft.png>)
![Alt text](<scr5 soft.png>)
## RESULT:
